...
label = tk.Label(root_VD, text="Inventory Management System", font=("Helvetica", 16))
...
def view_inventory():
    if len(inventory) == 0:
        ...
        scrollbar = tk.Scrollbar(view_window_VD, orient="vertical")
        inventory_listbox_VD.config(yscrollcommand=scrollbar.set)
        scrollbar.config(command=inventory_listbox_VD.yview)
        scrollbar.pack(side="right", fill="y")


# Create a button for viewing the inventory
view_button_VD = tk.Button(root_VD, text="View Inventory", command=view_inventory)
view_button_VD.config(width=30, height=5)
view_button_VD.place(relx=0.2, rely=0.24, anchor="sw")
...
def add_vehicle():
    ...
    vin_label = tk.Label(root_VD, text="Enter the vehicle VIN: ")
    vin_entry = tk.Entry(root_VD, textvariable=vin_var_VD)

    make_model_label = tk.Label(root_VD, text="Enter the vehicle make and model: ")
    make_model_entry = tk.Entry(root_VD, textvariable=make_model_var_VD)

    year_label = tk.Label(root_VD, text="Enter the vehicle year: ")
    year_entry = tk.Entry(root_VD, textvariable=year_var_VD)

    price_label = tk.Label(root_VD, text="Enter the vehicle price: ")
    price_entry = tk.Entry(root_VD, textvariable=price_var_VD)

    stock_number_label = tk.Label(root_VD, text="Enter the vehicle stock number: ")
    stock_number_entry = tk.Entry(root_VD, textvariable=stock_number_var_VD)
    ...
    submit_button = tk.Button(root_VD, text="Submit", command=lambda: submit_vehicle(vin_var_VD, make_model_var_VD, year_var_VD, price_var_VD, stock_number_var_VD, vin_label, vin_entry, make_model_label, make_model_entry, year_label, year_entry, price_label, price_entry, stock_number_label, stock_number_entry, submit_button, clear_button))
    submit_button.place(relx=0.75, rely=0.6, anchor="w")

    # Create a clear window button
    clear_button = tk.Button(root_VD, text="Clear", command=lambda: clear_add(vin_label, vin_entry, make_model_label, make_model_entry, year_label, year_entry, price_label, price_entry, stock_number_label, stock_number_entry, submit_button, clear_button))
    clear_button.place(relx=0.76, rely=0.65, anchor="w")
...
add_button = tk.Button(root_VD, text="Add Vehicle", command=add_vehicle)
...
def remove_vehicle():
    ...
    stock_number_label = tk.Label(root_VD, text="Enter the stock number of the vehicle to be removed: ")
    stock_number_entry = tk.Entry(root_VD, textvariable=stock_number_var_VD)
    ...
    # Create a submit button
    submit_button = tk.Button(root_VD, text="Submit", command=lambda: submit_stock_number(stock_number_var_VD, stock_number_label, stock_number_entry, submit_button, clear_button))
    submit_button.place(relx=0.75, rely=0.6, anchor="center")

    # Create a clear window button
    clear_button = tk.Button(root_VD, text="Clear", command=lambda: clear_remove(stock_number_label, stock_number_entry, submit_button, clear_button))
    clear_button.place(relx=0.73, rely=0.65, anchor="w")
...
remove_button = tk.Button(root_VD, text="Remove Vehicle", command=remove_vehicle)
...
def search_vehicle():
    make_model_var_VD = tk.StringVar()
    year_var_VD = tk.StringVar()
    make_model_label = tk.Label(root_VD, text="Enter the make and model of the vehicle: ")
    make_model_label.place(relx=0.5, rely=0.50, anchor="center")
    make_model_entry = tk.Entry(root_VD, textvariable=make_model_var_VD)
    make_model_entry.place(relx=0.5, rely=0.55, anchor="center")
    year_label = tk.Label(root_VD, text="Enter the year of the vehicle: ")
    year_label.place(relx=0.5, rely=0.60, anchor="center")
    year_entry = tk.Entry(root_VD, textvariable=year_var_VD)
    year_entry.place(relx=0.5, rely=0.65, anchor="center")
    submit_button = tk.Button(root_VD, text="Submit", command=lambda: submit_search(make_model_var_VD, year_var_VD, make_model_label, year_label, make_model_entry, year_entry, submit_button, clear_button))
    submit_button.place(relx=0.75, rely=0.6, anchor="center")
    clear_button = tk.Button(root_VD, text="Clear", command=lambda: clear_search(make_model_label, year_label, make_model_entry, year_entry, submit_button, clear_button))
    clear_button.place(relx=0.73, rely=0.65, anchor="w")
...
search_button = tk.Button(root_VD, text="Search Vehicle", command=search_vehicle)
...
exit_button = tk.Button(root_VD, text="Exit", command=root_VD.destroy)
